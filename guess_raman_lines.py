...
def guess_peaks(n_array: np.ndarray, input_parameters: dict, verbose: int = 1) -> ModelResult:
    """
    ...
    while y_residual.max() > noise_level and n_peaks <= max_n_peaks \
